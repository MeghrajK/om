<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="QckFnd_Land.aspx.cs" Inherits="QckFnd_Land" Title="Untitled Page" %>
...
<asp:Content ID="Content5" runat="server" contentplaceholderid="ContentPlaceHolder2">
        <div class="QckFnd_Res">
                <asp:Panel runat="server" ID="Panel1" ScrollBars="Both">
                    <asp:GridView ID="GV_QckFnd" runat="server" AutoGenerateColumns="False" 
                        ...
                        onselectedindexchanged="GV_QckFnd_SelectedIndexChanged" DataKeyNames="Land_id" 
