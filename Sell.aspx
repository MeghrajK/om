<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Sell.aspx.cs" Inherits="Sell" Title="Untitled Page" %>
    ...
    <div id="navigation">
		<div id="navigation_inner">
			...
			<ul>
				...
				<li class="current_page_item"><a href="Sell.aspx">Selling</a></li>
                            ...
                            <tr style="height:25px;">
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_Fname" runat="server" 
                                        ...
                                        ControlToValidate="Tb_Fname1" ValidationGroup="Sell_Valid"></asp:RequiredFieldValidator>
                                        &nbsp;
                                    <asp:RegularExpressionValidator ID="REV_Fname" runat="server"
                                     ...
                                     Font-Size="Medium" ValidationGroup="Sell_Valid" ValidationExpression="[aA-zZ]*$"> 
                                ...
                                <td>
                                    <asp:Label ID="LblMname" runat="server" Text="Middle Name" CssClass="Lbl1"></asp:Label>
                                     ...
                                     <asp:RequiredFieldValidator ID="RFV_Mname" runat="server" 
                                        ...
                                        ControlToValidate="Tb_Mname1" ValidationGroup="Sell_Valid"></asp:RequiredFieldValidator>
                                    &nbsp;
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_Lname" runat="server" 
                                        ...
                                        ControlToValidate="Tb_Lname1" ValidationGroup="Sell_Valid"></asp:RequiredFieldValidator>
                                    &nbsp;
                            ...
                            <td style="width:180px; ">
                                ...
                                <div style="float:right">
                                    <asp:RequiredFieldValidator ID="RFV_Mobno" runat="server" 
                                        ...
                                        ControlToValidate="Tb_Mobno1" ValidationGroup="Sell_Valid"></asp:RequiredFieldValidator>
                                    ...
                                    <asp:RegularExpressionValidator ID="REV_Mobno" runat="server"
                                     ...
                                     Font-Size="Medium" ValidationGroup="Sell_Valid" ValidationExpression="[0-9]*$">
                                    </asp:RegularExpressionValidator>     
                                </div>
                        ...
                        <tr>
                            ...
                            &nbsp;
                             <%-- <asp:RegularExpressionValidator ID="REV_Email" runat="server"
                                     ErrorMessage="# - Enter valid email id" Text="#" ControlToValidate="Tb_Email1" 
                                     Font-Size="Medium" ValidationGroup="Sell_Valid" >
                                    </asp:RegularExpressionValidator>   --%> 
                            </td>
                            <td>
                                &nbsp;</td>
            ...
            <div style="height:70px;">
                <div style="width:120px; margin:15px auto;">
                    <asp:Button ID="Btn_Save1" runat="server" Text="Save" CssClass="Btn_General" 
                        Width="120px" Height="35px" onclick="Btn_Save1_Click" ValidationGroup="Sell_Valid" />
                </div>
            </div>  
            <div>
                <asp:ValidationSummary ID="VS_Sell" DisplayMode="BulletList" ValidationGroup="Sell_Valid" Font-Size="12px" runat="server" ShowSummary="false" ShowMessageBox="true" />
            </div>  
            <div style="height:10px;"></div>    
        </div>
     </div>           
