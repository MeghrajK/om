<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="EditHomeDetails.aspx.cs" Inherits="EditHomeDetails" Title="Untitled Page" %>
                            ...
                            <div style="height:80px;">
                                <table style="width: 100%; height:100%;">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:CheckBox ID="CB_Sale" runat="server" Text="Sale" CssClass="LblGeneral" 
                                                />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DP_Type" runat="server" Width="200px"
                                             DataSourceID="DS_Type1" DataTextField="Description" DataValueField="Description">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <fieldset style="width:665px; height:70px; padding:0px;">
                                        ...
                                        <div style="height: 45px; padding-left:15px;">
                                            <div style="float:left">
                                                <asp:FileUpload ID="FU_EditHome" runat="server" Width="296px"/>
                                            </div>
                                            <div style="float:right; width:340px;">
                                                <div style="float:left; width:30px;">
                                                    <asp:Image ID="Img_IsHome" runat="server" Width="30px" Height="20px"/>
                                                </div>
                                                <div style="float:left; width:10px;"></div>
                                                <asp:LinkButton ID="LB_Img1" runat="server">LinkButton</asp:LinkButton>
                                            </div>
                                        </div>
                                     ...
                                     <div style="height:10px;"></div>
                                        <div style="height:70px;">
                                            ...
                                            <asp:Button ID="Btn_Update" runat="server" Text="Update" CssClass="Btn_General" 
                                            Width="120px" Height="35px" onclick="Btn_Update_Click"/>
                                        </div>
                                     </div>
...
<asp:Content ID="Content6" runat="server" contentplaceholderid="CPH_New">
